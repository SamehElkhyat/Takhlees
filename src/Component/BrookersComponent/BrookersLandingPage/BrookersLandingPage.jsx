        ...
        <div className="row d-flex justify-content-center align-items-center flex-row-reverse">
          <div className="col-md-12 d-flex justify-content-center align-items-center">
            <div
              ...
              <i className="fa-solid fa-code-pull-request" style={{fontSize:"40px", padding:"20px"}}></i>
            ...
            <div
              ...
              >
              <div className="card-body">
              <i className="fa-solid fa-envelope-open-text" style={{fontSize:"40px", padding:"20px" ,color:"#71c241"}}></i>
            ...
            <div
              ...
              >
              <div className="card-body">
              <i className="fa-solid fa-clock-rotate-left" style={{fontSize:"40px", padding:"20px",color:"#1ea9e2"}}></i>
            ...
            <div
              ...
              >
              <div className="card-body">
              <i className="fa-solid fa-cart-shopping" style={{fontSize:"40px", padding:"20px" ,color:"#1A39A0"}}></i>
