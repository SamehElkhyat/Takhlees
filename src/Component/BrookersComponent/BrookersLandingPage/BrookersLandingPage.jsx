  ...
  return (
    <Container className="mt-5 text-center">
      <div className="container text-center py-5">
        ...
        >
          <span className="text-black d-inline-block p-2">مرحبًا بك!</span>
        </h1>
      </div>
      <h5
        className="mb-4"
            ...
            {DecodedTokken === "Broker" ? (
              <>
                <Col md={3} sm={6} xs={12} className="Col3">
                  <Link className=" text-decoration-none" to="/HistoryOfOrders">
                    <Card
                      style={styles.cards3}
                      className="text-center mb-3"
                ...
                <Col md={3} sm={6} xs={12} className="Col4">
                  <Link className=" text-decoration-none" to="/BrookersCart">
                    <Card
                      style={styles.cards4}
                      className="text-center mb-3"
